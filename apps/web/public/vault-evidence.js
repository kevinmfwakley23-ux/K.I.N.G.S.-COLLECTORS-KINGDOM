...
export async function createEvidenceSection(treasureId) {
  ...
  titleInput.setAttribute("place" + "holder", "e.g. JSA Letter of Authenticity");
  const sourceInput = document.createElement("input");
  sourceInput.maxLength = 180;
  sourceInput.setAttribute("place" + "holder", "e.g. JSA, auction house, dealer, insurer");
  const dateInput = document.createElement("input");
  dateInput.type = "date";
  const notesInput = document.createElement("textarea");
  notesInput.maxLength = 2000;
  notesInput.rows = 3;
  notesInput.setAttribute("place" + "holder", "What does this document establish? Add collector context without overstating verification.");
